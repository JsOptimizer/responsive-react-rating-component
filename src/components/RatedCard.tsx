...
const RatedCard = ({rating}:TRatedCard) => {
  return (
    <article className="bg-secondary p-8 rounded-3xl  space-y-8">
      ...
      <div className="flex justify-center"><h3 className="text-primary bg-neutral-50 bg-opacity-20 text-opacity-60 py-1 px-3 rounded-full text-sm font-overpasse">{`You selected ${rating} out of 5`}</h3></div>
      <h1 className="text-neutral text-center text-2xl font-overpasse">Thank you!</h1>
      <p className="text-neutral-50 text-center text-xs lg:text-base">
